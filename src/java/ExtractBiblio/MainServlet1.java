    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("biblio") != null) {
            if (ValidateInput.checkInput1(patPubNo)) {
                String countryCode = ValidateInput.splitPatPubNo.get("countrycode");
                String inputPatPubNo = ValidateInput.splitPatPubNo.get("patpubno");
                String kindCode = ValidateInput.splitPatPubNo.get("kindcode");
